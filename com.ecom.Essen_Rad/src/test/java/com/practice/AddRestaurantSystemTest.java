...
public class AddRestaurantSystemTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.name("submit")).click();
		String aRest = driver.findElement(By.xpath("//div[@class='alert alert-success alert-dismissible fade show']")).getText();
		if (aRest.contains(expect)) {
